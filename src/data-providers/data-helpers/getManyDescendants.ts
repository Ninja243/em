 ...
 */
const getManyDescendants = async function* getManyDescendants(provider: DetaProvider, contextMap: Index<Context>, { maxDepth = 100 } = {}): AsyncIterable<ThoughtsInterface> {
